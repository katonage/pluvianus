...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        central_widget.setWindowTitle('pyqtgraph example: Interactive color bar')
        central_widget.resize(800,700)
        ...
        layout.addWidget(gr_wid)
        layout.addWidget(QLabel("S my label here nu"))
        self.show()
